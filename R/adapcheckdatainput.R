adapcheckdatainput <-
function(dat, response, treatment, runsnorm, sampleID, normalizeby, forfitting, runsmodel=NULL, spiked=NULL)
{
...
if(any(treatment %in% sampleID)){stop("The column of the data set that has been chosen as dsitinguishing sample types, has also been selected as the column distinguishing the individual biological samples.")}
...
return(list("DATINT"=DATINT, "normTAB"=TAB, "textnormunit"=textnormunit, "textnormlev"=textnormlev))
